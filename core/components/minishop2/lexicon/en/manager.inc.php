...
$_lang['ms2_body_user'] = 'Chunk for email to user';
$_lang['ms2_body_manager'] = 'Chunk for email to manager';
...
$_lang['ms2_price'] = 'Price';
$_lang['ms2_price_help'] = 'Minimum cost of delivery';
$_lang['ms2_weight_price'] = 'Cost of 1 u/w';
$_lang['ms2_weight_price_help'] = 'Additional cost per unit of weight.<br/>Can be used in custom classes.';
$_lang['ms2_distance_price'] = 'Cost of 1 u/d';
...
$_lang['ms2_order_requires_help'] = 'When ordering, a custom class can require the completion of these form fields';
...
$_lang['ms2_link_one_to_one_desc'] = 'Connection of one single product to another single product. If you want to connect more than 2 products, you need to use the "many-to-many".';
$_lang['ms2_link_one_to_many'] = 'One to many';
$_lang['ms2_link_one_to_many_desc'] = 'The connection of one master product with multiple slave products. For example, a master product to a set of complimentary products. Well suited for the specifying recommended goods.';
$_lang['ms2_link_many_to_one'] = 'Many to one';
$_lang['ms2_link_many_to_one_desc'] = 'Link multiple slave products to a master where the salve products have no connection with each other. For example, goods are included in a set.';
$_lang['ms2_link_many_to_many'] = 'Many to many';
$_lang['ms2_link_many_to_many_desc'] = 'Interconnected linking many goods. All the products in the group are connected to each other, with the addition of a new product to the group, all other will inherate the connection. Typical applications: link by one parameter, such as color, size, language, version, etc.';
